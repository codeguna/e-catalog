                                                ...
                                                <td>
                                                    <div class="input-group quantity mt-4" style="width: 100px;">
                                                        <input type="number" name="quantity[]"
                                                            ...
                                                            value="{{ $items->quantity }}" min="0">
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="{{ route('delete', $items->id) }}"
                    ...
                    <div class="bg-light rounded">
                        <div class="p-4">
                            ...
                            <div class="d-flex justify-content-between mb-4">
                                ...
                                <p class="mb-0" id="total-price-display">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const totalDisplay = document.querySelector(
                '#total-price-display'); // Tambahkan id ini di elemen total harga

            function updateTotalPrice() {
                let total = 0;
                quantityInputs.forEach((qtyInput, index) => {
                    const qty = parseInt(qtyInput.value) || 0;
                    const price = parseInt(priceInputs[index].value) || 0;
                    total += qty * price;
                });
